<div class="tab-pane" id="mistakes" data-second="1">

    <form>
        <h2 class="page-header">严重失误--工作失误</h2>
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tr data-department="${department.id}" data-second="1">
                    <td>${department.shortName}</td>
                    <td class="exclusion">
                        <input type="text" class="form-control" name="score" data-validate="negative" data-max="0" data-min="-5">
