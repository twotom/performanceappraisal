<div class="container" id="satisfaction" data-indicator="2">
    <form>
        <h2 class="page-header">满意度评价--服务对象评价</h2>
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                <#assign elements = ['服务意识', '服务态度', '服务效果', '服务能力']>
        ...
        <div class="col-sm-2 col-sm-offset-10">
            <button class="btn btn-block btn-primary satisfaction_btn" ${overtime?then("", "disabled")} title="${overtime?then("提交", "已超过截至日期")}" type="button" data-indicator="2">提交</button>
        </div>
    </form>
