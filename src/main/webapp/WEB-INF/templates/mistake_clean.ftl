<div class="tab-pane" id="mistakes" data-second="4">

    <form>
        <h2 class="page-header">严重失误--党风廉政</h2>
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tr data-department="${department.id}" data-second="4">
                    ...
                    <td>
                        ...
                        <button class="btn btn-block btn-primary" data-target="#upload-modal" data-toggle="modal"
                                type="button">上传文件
                        </button>
                    </td>
                </tr>
